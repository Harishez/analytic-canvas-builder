...
export function LineChartView() {
  ...
  // Prepare data for standard line chart
  ...
  // Prepare data for comparison groups line chart
  function prepareComparisonData() {
    ...
    // For comparison data with line chart, we'll create one data point per metric
